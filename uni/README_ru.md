...
и ```$frontendControllers```, происходят следующие вещи:
1) Вот эти два св-ва естественно возьмутся у модуля родителя
...
3) Имеются следующие возможности как указать модулю взять контроллеры от родителя:
    ...
    * Если же контроллеры в каком то другом модуле, то установите namespace этого модуля в ```$baseControllerNamespace``` вашего
