...
1. Объединить ActiveRecord модели одной таблицы в дерево по алгоритму Materialized path, с помощью [данного](https://github.com/mgrechanik/yii2-materialized-path) расширения
2. Вы можете использовать свою ActiveRecord модель, с нужными вам полями, унаследовав ее от базовой модели данного расширения
