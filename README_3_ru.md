...
Данный ACO алгоритм находит хорошие пути на графе. И даже лучшие. Для сравнения берем библиотеку TSPLIB95, которая содержит исходные данные для Задачи коммивояжера, и дает лучшие рузультаты, которые были когда либо найдены (пути и расстояния).
...
Здесь я использовал поисковик на основе алгоритма с использования элитных муравьев. Он на практике дает лучшие результаты, чем классический.
